...
declare module amp {
  ...
  interface Player {
    ...
    /**
         * Returns the playable window end time in seconds, regardless of if presentation is live or VOD, as long as it's available.
         * Returns undefined if it's not available.
         * 
         * @return Playable window end time in seconds
         */
...
         */
  ...
  export class errorCode {
    ...
    /**
         ...
         */
    static srcErrLiveNoSegments: number;
...
declare module amp.Player {
  ...
  interface Options {
    ...
    /**
         * Disable the button that makes the video go into fullscreen mode.
         * To fully disable going into fullscreen mode, also disable HotKeys.enableFullscreen
         * Default is false.
         */
